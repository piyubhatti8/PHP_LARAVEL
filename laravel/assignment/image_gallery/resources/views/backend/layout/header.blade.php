...
<head>
    ...
    <title>Image Gallery Admin Panel</title>
	<!-- BOOTSTRAP STYLES-->
...
@include('sweetalert::alert')
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="admin_index"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                      <li>
                        <a  href="add_images"><i class="fa fa-	 fa-3x"></i>Add Photos</a>
                    </li>
                    <li>
                        <a  href="manage_users"><i class="fa fa-	 fa-3x"></i>Manage Users</a>
                    </li>
 ...
 <!-- SCRIPTS -AT THE BOTOM TO REDUCE THE LOAD TIME-->
    ...
    <script src="backend/assets/js/custom.js"></script>
      ...
      <!-- DATA TABLE SCRIPTS -->
    <script src="backend/assets/js/dataTables/jquery.dataTables.js"></script>
    <script src="backend/assets/js/dataTables/dataTables.bootstrap.js"></script>
        <script>
