...
@section('main_container') 
    ...
    <div class="site-section"  data-aos="fade">
      <div class="container-fluid">
        ...
        <div class="row mb-5">
          <div class="col-md-7">
            <img src="{{url('frontend/assets/images/img_2.jpg')}}" alt="Images" class="img-fluid">
          </div>
        ...
        <div class="row site-section">
          <div class="col-md-6 col-lg-6 col-xl-4 text-center mb-5">
            <img src="{{url('frontend/assets/images/person_1.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-6 col-xl-4 text-center mb-5">
            <img src="{{url('frontend/assets/images/person_2.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-6 col-xl-4 text-center mb-5">
            <img src="{{url('frontend/assets/images/person_4.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
